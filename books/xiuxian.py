...
class ChinaDaily(BaseFeedBook):
    # 设定生成电子书的元数据
    title = u'xiaoshuo' # 设定标题
    __author__ = u'ren' # 设定作者
    description = u'就是自己爬的小说啦 ' # 设定简介
    language = 'ch' # 设定语言

    #coverfile = 'cv_bound.jpg' # 设定封面图片
    #mastheadfile = 'cv_bound.jpg' # 设定标头图片

    # 指定要提取的包含文章列表的主题页面链接
    # 每个主题是包含主题名和主题页面链接的元组
    feeds = [
        (u'xiuxian', 'https://www.biqudd.com/6_6360/'),
        (u'chuming', 'https://www.biqudd.com/1_1640/'),
    ]

    page_encoding = 'gbk' # 设定待抓取页面的页面编码
    ...
    max_articles_per_feed = 4 # 设定每个主题下要最多可抓取的文章数量
